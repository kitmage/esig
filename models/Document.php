...
class WP_E_Document extends WP_E_Model {
    ...
    private $table, $usertable, $documentsSignaturesTable, $eventsTable, $invite, $signature, $validation, $user, $settings;
...
EOL;
    ...
    public function allSadpages() {

        // get cache
        $default_page = wp_cache_get('esig_sad_pages', 'esig');
        if ($default_page) {
            return $default_page;
        }
        ...
        // set cache 
        wp_cache_set('esig_sad_pages', $default_page, 'esig');
        return $default_page;
    }
