...
//if close button is clicked
    ...
    $('body').on('click', '#esig-system-checklist-later', function () {
...
//if mask is clicked
    ...
    $.fn.esig_system_check = function (number) {
       ...
       return $.ajax({
           ...
           url: esigAjax.ajaxurl + "?action=wp_e_signature_ajax&className=WP_E_aboutsController&method=esig_requirement_checking&_wpnonce=" + esigAjax._wpnonce , //Your form processing file URL
