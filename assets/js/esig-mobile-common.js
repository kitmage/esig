(function ($) {
    ...
    if(canvaswidth > 500)
    {
        ...
        //$("#signatureCanvas").attr("height", 500);
    }
    else {
        $("#signatureCanvas").attr("width", canvaswidth-35);
    }
    //}
    ...
    $("#mobile-sigpad").on("tap click touchmove taphold", function () {
        //console.log('here');
    ...
    // when some tab in draw section next step button enabled
    $("#signatureCanvas").on("swipe touchmove tap taphold click", function () {
        //console.log('here');
    ...
    $(".clearButton").on("tap click", function () {
    ...
    $("#mobile-next-step").on("tap click", function (e) {
    ...
    $("#mobile-go-back").on("click", function () {
       ...
       // $('.signature-wrapper').signaturePad().enableCanvas();
        ...
        if($("#mobile-type-sig").hasClass("active")){
            $("#mobile-type-signature").show();
            $("#mobile-draw-signature").hide();
