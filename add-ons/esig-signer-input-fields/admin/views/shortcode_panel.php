<div id="esig-sif-admin-panel" style="display:none;">
    <div class="esig-sif-main-panels">
        ...
        <div class="esigpanel esig-sif-panel-textfield" style="display:none;">
            ...
            <div id="sif_textbox_advanced_content" class="sif_textbox_advanced_content" style="display:none;">
            <?php _e('Max Width:', 'esig'); ?> <input type="text" id="maxsize" name="textbox_width" size="4" value=""><?php _e('Px', 'esig'); ?>
                <br>
                <br>
                <?php _e('Field Type', 'esig'); ?> <br>
                <input type="radio" id="esig-sif-textfield-option" value="text" name="esig_textfield_option"> <?php _e('Default', 'esig'); ?>
                <input type="radio" id="esig-sif-textfield-option" value="number" name="esig_textfield_option"> <?php _e('Number', 'esig'); ?>
                <input type="radio" id="esig-sif-textfield-option" value="email" name="esig_textfield_option"> <?php _e('E-mail', 'esig'); ?>
                <input type="radio" id="esig-sif-textfield-option" value="url" name="esig_textfield_option"> <?php _e('Url', 'esig'); ?>
                <hr width="100%">
        ...
        <div class="esigpanel esig-sif-panel-file" style="display:none;">
            ...
            <div class="sif_popup_main_file">
                <div class="esig-sif-popup-left">
                    ...
                    <?php _e('Enter your field label', 'esig'); ?>
            ...
            <div style="display:inline-flex;margin:15px 0;">
                ...
                <?php _e('Allowed file extensions are jpg, jpeg, jpe, gif, png, pdf', 'esig'); ?>
            </div>
            <div style="margin:15% 0;" align="center">
            ...
            <?php _e('Max File Size:', 'esig'); ?>
                ...
                </span><?php echo preg_replace('/[^GM]/', '', ini_get('upload_max_filesize')); ?>
                <hr width="100%">
                <span class="sif-advanced-text">
                    <?php _e('Specify the maximum file size in megabytes allowed for the uploaded files.', 'esig'); ?>
                </span>
                <hr width="100%">
                <?php _e('Maximum allowed in this server :', 'esig'); ?><span id="esig-maximum-file-size"> <?php echo(ini_get('upload_max_filesize')) ; ?> </span>
            </div>
        ...
        <div class="esigpanel esig-sif-panel-textarea" style="display:none;">
            <div class="sif_popup_container">
                ...
                <div class="sif_popup_right" valign="top">
                    <!-- textbox advanced area -->
                    <div class="sif_advanced_button_area" align="right">
                        <button data-id="show" id="sif_textarea_advanced_button" class="advanced-button esig-icon-settings">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <?php _e('Min date:', 'esig'); ?> <input type="text" id="esig-date-pick-mindate" placeholder="mm/dd/yyyy" name="datepickerstartdate" value=""><br><br>
                        <?php _e('Max date:', 'esig'); ?> <input type="text" id="esig-date-pick-maxdate" placeholder="mm/dd/yyyy" name="datepickerenddate" value="">
                    </div>
                </div>
            </div>
            ...
            <div class="sif_popup_container">
                ...
                <div class="sif_popup_right" valign="top">
                    ...
                    <div class="sif_advanced_button_area">
                        <button data-id="show" id="sif_radio_advanced_button" class="advanced-button esig-icon-settings">
                            <?php _e('Advanced', 'esig'); ?>
                        </button>
                    </div>
                    <!-- others area start here -->
            ...
            <div class="sif_popup_container">
                ...
                <div class="sif_popup_right" valign="top">
                    ...
                    <div id="sif-checkbox-advanced-button" class="sif_advanced_button_area">
                        <button data-id="show" id="sif_checkbox_advanced_button" class="advanced-button esig-icon-settings">
                            <?php _e('Advanced', 'esig'); ?>
                        </button>
                    </div>
                    <!-- others area start here -->
