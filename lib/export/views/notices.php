...
<div id="esig-db-migration-alert" class="notice notice-warning esig-notice" style="border-top: 1px solid #f1f1f1;padding:14px;">
    ...
    <div style="width:80%;display:inline-block;font-size: 16px;font-weight: 500;"><?php _e("WP E-Signature needs to upgrade your document database.", "esig"); ?> <a href="https://www.approveme.com/wordpress-contract-plugin/mcrypt-php-replaced-open-ssl/" class="learn-more" style="text-decoration:underline;" target="_blank"><?php _e("learn more", "esig"); ?></a></div>
    <div style="width:18%;display:inline-block;text-align:right;"><a  href="#" id="esig-update-now-clicked" class="esig-update-btn"> <?php _e("Update Now", "esig"); ?> </a></div> 
...
<div id="esig-db-tools-dialog" class="esig-db-update-dialog" style="display:none;">
    ...
    <div class="esig-dialog-header" style="margin-bottom: 20px;"> <h3><?php _e("Update E-Signature Database", "esig"); ?></h3> </div>
    ...
    <div id="esig-db-update-now-window" class="update-now-window" <?php echo $display; ?>>
        ...
        <div class="update-main-container">
            ...
            <div class="esig-db-update-now-btn" style="text-align: center">
                <a href="<?php echo esigMigrate::instance()->migrateLink(); ?>" id="esig-db-btn-update-now" class="button-primary"> <?php _e("Update Now", "esig"); ?></a>
            </div>
        </div>
    ...
    <div id="esig-db-export-now-window" <?php echo $displayExport; ?>>
        ...
        <div class="esig-db-update-now-btn" style="text-align: center;margin-top:30px;">
            <div style="width:48%;display:inline-block;text-align: center;"> 
                <a href="<?php echo esig_export::instance()->exportLink(); ?>" id="esig-db-btn-export-now" class="button-primary">  <?php _e("Export Now", "esig"); ?></a>
            </div>
            <div style="width:50%;display:inline-block;text-align:center;vertical-align: middle;font-size: 16px;font-family: vardana;font-weight:700;">
                <a href="<?php echo esigMigrate::instance()->migrateLink(); ?>" class="esig-migrate-anyway" id="esig-db-btn-update-now">  <?php _e("Update without exporting", "esig"); ?></a>
            </div>
        </div>
