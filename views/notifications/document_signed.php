...
<div id=":zs" class="ii gt m1436f203bed358e3 adP adO">
	<div id=":zr" style="overflow: hidden;">
		<div class="adM"></div>
		<div style="background-color:#efefef;margin:0;padding:0;font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;width:100%;max-width:600px;margin: 0 auto;<?php if(is_rtl()){ ?> direction:rtl; <?php } ?>">
								...
								<tbody>
									<tr style="border-collapse:collapse">
										<td style="font-family:'HelveticaNeue',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;border-collapse:collapse" align="left" width="100%">
											<div style="margin:0 0 20px 0;<?php if(is_rtl()){ ?> float:right !important; <?php } ?>">
												...
												<p <?php echo $logo_alignment; ?> <?php if(is_rtl()){ ?> style='text-align:right !important;'; <?php } ?>>
														...
														<td style="background-color:#ffffff;border:1px solid #ccc;padding:15px;" bgcolor="FFFFFF">
															...
															<div style="margin:20px 0px 20px 0px">
																...
																<table cellspacing="0" cellpadding="0"> 
																	<tr>   
																		<td align="center" height="50" bgcolor="<?php echo $data['background_color']; ?>" style="color: #ffffff; display: block;width:auto;min-width:200px">
																			<a href="<?php echo $data['view_url']; ?>" style="font-size:14px;font-family:sans-serif; text-decoration: none; line-height:50px; width:100%; display:inline-block;padding-left: 3%;padding-right: 3%;">
