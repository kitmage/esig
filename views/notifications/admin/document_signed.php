																...
																<table cellspacing="0" cellpadding="0">
																	<tr>  
																		<td align="center" height="50" bgcolor="<?php echo $data['background_color']; ?>" style="color: #ffffff; display: block;width:auto;min-width:200px">
																			<a href="<?php echo $data['view_url']; ?>" style="font-size:14px; font-family:sans-serif; text-decoration: none; line-height:50px; width:100%; display:inline-block;padding-left: 3%;padding-right: 3%;"><span style="color: #ffffff;padding-left: 3%;padding-right: 3%;"><?php _e('View Signed Document','esig'); ?></span></a>
																		</td>   
																	</tr> 
																</table>
