			...
			<table class="form-table esig-settings-form">
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" name="first_name" id="first_name" value="<?php if (array_key_exists('first_name', $data)) {
					...
					<tr>
						...
						<td><input type="text" name="last_name" id="last_name" value="<?php if (array_key_exists('last_name', $data)) {
																							echo $data['last_name'];
																						} ?>" class="regular-text" /></td>
					...
					<tr>
						...
						<td><input type="text" name="user_email" id="user_email" size="30" value="<?php if (array_key_exists('user_email', $data)) {
																										echo $data['user_email'];
																									} ?>" class="regular-text" />

							<br />

							<span class="description"><?php _e('Enter the E-Signature admin email address that you would like all document communications sent.', 'esig'); ?></span>
						</td>
					...
					<tr>
						...
						<td><input type="text" name="user_title" id="user_title" maxlength="64" size="30" value="<?php if (array_key_exists('user_title', $data)) {
					...
					<tr>
						...
						<td>
							...
							<div class="signature-wrapper-displayonly">
								...
								<div aria-label="Sign here" id="signatureCanvas2" class="sign-here pad <?php echo $data['signature_classes']; ?>" style="width:100%;"><?php echo esigget("outputSignature", $data); ?></div>
								...
								<div id="tabs">
											...
											<div class="full-name">
												...
												<div class="wrapper">
													...
													<div class="text-input-wrapper">
														...
														<input id="esignature-in-text" value="<?php if (array_key_exists('output_type', $data)) {
																									echo $data['output_type'];
																								} ?>" name="esignature_in_text" class="required text-input" maxlength="64" type="text">
									...
									<div id="tabs-1">
										...
										<div class="signature-wrapper">
											...
											<a href="#clear" id="esig-admin-signaturepad-clear" class="clearButton" style="margin-bottom:25px;"><?php _e('Clear', 'esig'); ?></a>

											<canvas aria-label="Sign here" id="signatureCanvas" class="sign-here pad <?php echo $data['signature_classes']; ?>" width="410" height="85"></canvas>

											<input type="hidden" id="admin-signature-output" name="output" class="output" value='<?php if (array_key_exists('output', $data)) {
																																		echo $data['output'];
																																	} ?>' />
											...
											<div id="type-in-signature">
												...
												<div id="esig-type-in-preview" class="pad" width="450px" height="100px">
													...
													if (array_key_exists('output_type', $data)) {
														...
														if(!$font_choice) {
															$font_choice =  WP_E_Sig()->setting->get_generic('esig-signature-type-font' . $wp_user_id);
														}
					...
					<tr>
						...
						<th><label for="esig_super_admin" id="esig_super_admin"><?php _e('Super-Admin', 'esig'); ?></label>
					...
					?>
						...
						<tr>
							...
							<th><label for="default_display_page" id="default_display_page"><?php _e('E-Signature Page', 'esig'); ?></label>
						...
						<tr>
							...
							<td><label for="">
									...
									<?php $esig_default_page_hide = $data['esig_default_page_hide'];
									if ($esig_default_page_hide == 1) {
										$eisg_page = "checked";
									} else {
										$eisg_page = "";
									} ?>
						...
						<tr>
							...
							<td>
								...
								<label for=""><a href="#" class="tooltip">
									...
									<input name="force_ssl_enabled" title="hello testing" id="esign_ssl" type="checkbox" value="1" <?php echo $data['ssl_checked']; ?>> <?php _e('Force secure signing.).', 'esig'); ?>
									<!--<a href="">Purchase an SSL certificate</a>  from WP E-Signature starting at $7.95 / yr.</label>-->

									<span class="description"><?php _e('Force SSL (HTTPS) on the signing pages (an SSL Certificate is required).', 'esig'); ?></span>
							</td>
