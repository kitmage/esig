...
<div class="signatures row" id="main-signature">
	<form name="readonly" class="form-inline">
		...
		if (empty($data['recipient_signatures'])) {
			echo '<div class="col-sm-6" id="signature-wrapper"><div class="signature-wrapper-displayonly recipient" style="margin-left:30px;"><canvas id="signatureCanvas2" class="sign-here pad sign-here" height="85"></canvas></div></div>';
		} else {
...
<div class="page-break-before row">
	<div class="esig-logo col-sm-8">
		<!--<img src="<?php // echo $data['assets_dir']; 
						?>/images/approveme-badge.svg" alt="WP E-Signature"/>-->
	</div>
</div>
