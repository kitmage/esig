									...
									<tr style="border-collapse:collapse">
										<td style="font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.4em;border-collapse:collapse" align="left" width="100%">
											...
											<table width="100%" style="width: 100%;border-collapse: collapse; ">
												<tbody>
													<tr>
														<td style="color:#444;background-color:#ffffff;border:1px solid #ccc;padding:15px;" bgcolor="#FFFFFF">
															...
															<p style="color:#444;line-height:1.4em;font-size:14px;font-family:sans-serif;margin:10px 0px">
															...
															<div style="margin:20px 0px 20px 0px;">
																...
																<table cellspacing="0" cellpadding="0">
																	<tr>
																		<td align="center" height="50" bgcolor="<?php echo $background_color;  ?>" style="color: #ffffff; display: block;">
																			<a href="<?php echo $data['invite_url']; ?>" style="font-size:14px; font-family:sans-serif; text-decoration: none; line-height:50px; min-width:150px; width:auto; display:inline-block;"><span style="color: #ffffff;padding-left: 3%;padding-right: 3%;"><?php _e('Review &amp; Sign', 'esig'); ?></span></a>
																		</td>
																	</tr>
																</table>
															</div>
