...
<table class="form-table">
	<tbody>
       ...
       <p><h3 class="esig-activate-license esign-feedback-alert"><span class="esig-icon-esig-alert"></span> <?php
         ...
         /*  if(isset($result->license) && $result->license == 'valid' &&  $result->license_type != 'business-license')
           {
                ...
                <div class="esig-add-on-block esig-pro-pack open">
                 <?php echo sprintf(__('<h3>Get the E-Signature Business Pack</h3>
                    ...
                    <a class="esig-btn-pro" href="https://www.approveme.com/login" target="_blank">Get all our add-ons for $%d</a> ','esig'),$amount); ?>
        ...
        <p><?php _e('Login to your account at','esig'); ?> <a href="https://www.approveme.com/login/" target="_blank"><?php _e('ApproveMe','esig'); ?></a><?php _e('. An email was sent with your username and password at the time of purchase.','esig'); ?></p>
        </div>
