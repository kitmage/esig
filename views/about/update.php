  ...
  <div id="esig-update-popup" style="display:none;">
		...
		<div class="esig-dialog-header">
		  ...
		  <?php _e('we have great news! We recently added some new features along with some 
		   critical security updates for <a href="https://www.approveme.com/wp-e-signature?updates" rel="nofollow" target="_blank">WP E-Signature</a>. How would you like to handle these updates?','esig'); ?> </p>
		</div>
	...
	<div class="esig-updator-scroll-wrap">
		...
		<?php 
				...
				if($auto_downloads)
				{
					...
					{
						 $addon_id = esigget("addon_id",$plugin);
						 if(array_key_exists($addon_id,$auto_downloads))
						   {
